...
public class MyAsyncApplication implements CommandLineRunner {

    public static void main(String[] args) {
        SpringApplication.run(com.marcuschiu.example.spring.boot.mastercodesnippet.MasterCodeSnippetApplication.class, args);
    }
